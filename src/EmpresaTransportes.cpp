		...
		else
		{
			...
			case 'v':
				...
				if(atributos[6] == "livre")
					veiculos.push_back(new TransporteActividadeRecreativa(atributos[1],stoi(atributos[2]),stof(atributos[3]), stof(atributos[4]), false, stoul(atributos[7])));
				else if(atributos[6] == "alugado")
					veiculos.push_back(new TransporteActividadeRecreativa(atributos[1],stoi(atributos[2]),stof(atributos[3]), stof(atributos[4]), true, stoul(atributos[7])));
				else
					veiculos.push_back(new TransporteEscolar(atributos[1],stoi(atributos[2]),stof(atributos[3]), stof(atributos[4]), stoul(atributos[6]), stoul(atributos[7])));
				break;
